# ⛓️ CLAUDE_EXECUTION_CONTRACT_v2.md
...
- **Irreducible Chain:** For multi-step tasks, output and strictly follow this sequence:
  ```text
  1. [Intervention] -> Verify (Provide a specific, executable command or a strict physical action to prove the state change. No conversational explanations.)
  2. [Intervention] -> Verify (Provide a specific, executable command or a strict physical action to prove the state change. No conversational explanations.)
  3. [Intervention] -> Verify (Provide a specific, executable command or a strict physical action to prove the state change. No conversational explanations.)
  ```
